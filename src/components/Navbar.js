  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        <CustomLink className="ml-4" href="/articles" title="Achievements" />
      </nav>
      <nav
      ...
      >
        ...
        <motion.a
          ...
          href="https://www.pinterest.se/karlssonliam05/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="ml-4 lg:m-0 lg:my-2" href="/Achievements" title="Achievements" />
      </nav>
      <nav
