...
export const HireMe = () => {
  return (
    <div className="fixed left-3 bottom-3 flex flex-col items-center justify-center overflow-hidden z-20 md:absolute md:left-auto md:right-8 md:bottom-auto md:top-0">
