  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn more about Liam Karlsson, a Next.js developer with a passion for 
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            md:col-span-8">
              ...
              <p className="font-medium ">
                Hi, I&apos;m <strong>Liam Karlsson</strong>, a Swedish Tech studentborn 2005 and with a passion for creating beautiful,
              ...
              In addition to my technical skills and design philosophy, I pride myself on my strong work ethic and ability to collaborate effectively with clients and colleagues alike. 
              </p>
<br></br>
<p className="font-medium">
